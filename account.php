                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Mini Statement
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            ?>
                                                ...
                                                <?php
                                                    ...
                                                    <?php
                                                    ministate($_SESSION['users'], $_REQUEST['mno'], $_REQUEST['tname']);
                                                    ?>
                                            <div class="col-md-4"> <button class="btn green" onclick="printResults()">Print </button> </div>
                                                    <!------form start----->

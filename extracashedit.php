                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>Extra Cash Module
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['editsubmit']) || isset($_REQUEST['eelid']) || isset($_REQUEST['deelid'])) {

                                                    if (isset($_REQUEST['editsubmit'])) {

                                                        editaddextracash($_SESSION['users'], $_REQUEST['id'], $_REQUEST['mno'], $_REQUEST['efee'], $_REQUEST['tid'], $_REQUEST['amount']);
                                                    }
                                                    ...
                                                    if (isset($_REQUEST['eelid'])) {

                                                        editextracashform($_SESSION['users'], $_REQUEST['eelid']);
                                                    }
                                                } else {

                                                        extracostloansedit($_SESSION['users'], $_REQUEST['elid'], $_REQUEST['tid']);
                                                }

...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            xmlhttp.open("GET", "./search/pasosearch.php?q=" + str, true);
                    xmlhttp.send();
            }
        </script>
        <!-- SimpleTabs -->
...
window.location.href = uri + base64(format(template, ctx))
                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Manual Interest Charge Module
                                                ...
                                                if (!isset($_REQUEST['view'])) {
                                                    ...
                                                    <div class="noprint">
                                                        <form action="" method="post">
                                                            ...
                                                            <div class="searcher">
                                                                <select name = "mysearch" onchange = "showUser(this.value)"  value = "' . $_REQUEST['mno'] . '" class="input-medium form-control select2me" placeholder="Select Member">
                                                                    <option></option>
    ...
    if (isset($_REQUEST['view'])) {
        ...
        <?php
        personalchargeinterest($_REQUEST['view'], $_REQUEST['mno']);
        ?>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    if (isset($_REQUEST['msubmit'])) {
        ...
        <?php
        addpersonalchargedinterest($_REQUEST['mno'], $_REQUEST['tid'], $_REQUEST['month']);
        ?>
                                                                </div>
                                                            </div>
                                                        </div>

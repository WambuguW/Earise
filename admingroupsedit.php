                ...
                <div class="col-md-offset-1 col-md-10 col-sm-10">
                    ...
                    <div class="portlet box green calendar">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-reorder"></i> Groups Edit
                        ...
                        <div class="portlet-body dark_green" style="color:#000000">
                            <div class="well dark_green">
                                ...
                                <div class="art-layout-cell art-content clearfix">
                                    <!------form start----->
                                    <?php
                                    if(isset($_REQUEST['adme'])){
                                        edditedGroupEdit($_REQUEST['adme']);
                                        $id= ($_REQUEST['adme']);
                                    ...
                                    if(isset($_REQUEST['userupdate'])){
                                        ...
                                        updateUsersGroup($_REQUEST['adme'],$_REQUEST['user'],$_REQUEST['status'],$_REQUEST['comment'],$_REQUEST['date'],$oldname);
                                    }
                                    if(isset($_REQUEST['admd'])){
                                      include ('del.php');   
                                    }
                                    if (!isset($_REQUEST['adme']) && !isset($_REQUEST['userupdate']) && !isset($_REQUEST['admd'])) {

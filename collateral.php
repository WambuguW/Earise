                        ...
                        <div class=" col-md-offset-1 col-md-11">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Add Collateral
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['create'])) {
                                                    ...
                                                    if ($image) {
                                                        ...
                                                        if (!$copied) {
                                                            ...
                                                            //$ok = 0;
                                                            $newuser->addcollateral($_SESSION['users'], $_REQUEST['mno'], $_REQUEST['descr'], $_REQUEST['idno'], $_REQUEST['value'], $_REQUEST['status'], $_REQUEST['comment'], $image);
                                                        } else {
                                                            $newuser->addcollateral($_SESSION['users'], $_REQUEST['mno'], $_REQUEST['descr'], $_REQUEST['idno'], $_REQUEST['value'], $_REQUEST['status'], $_REQUEST['comment'], $image);
                                                        }
                                                    }
                                                ...
                                                if (isset($_REQUEST['gid']) || isset($_REQUEST['gedit']) || isset($_REQUEST['save']) || isset($_REQUEST['gdel'])) {

                                                    if (isset($_REQUEST['gid'])) {

                                                        $id = $_REQUEST['gid'];

                                                        $sql = mysql_query('SELECT * FROM collateral WHERE id="' . $id . '"') or die(mysql_error());

                                                        $rows = mysql_fetch_array($sql);

                                                        collateraledit($rows['id'], base64_decode($rows['mno']), base64_decode($rows['name']), base64_decode($rows['idno']), base64_decode($rows['value']), base64_decode($rows['status']), base64_decode($rows['comment']), base64_decode($rows['image']));
                                                    }
                                                    ...
                                                    if (isset($_REQUEST['save'])) {
                                                        ...
                                                        if ($image) {
                                                            ...
                                                            if (!$copied) {
                                                                ...
                                                                // 0-unsuccessful, 1-successful
                                                                //$ok = 0;
                                                                collateralupdate($_SESSION['users'], $_REQUEST['id'], $_REQUEST['mno'], $_REQUEST['descr'], $_REQUEST['idno'], $_REQUEST['value'], $_REQUEST['status'], $_REQUEST['comment'], $image);
                                                            } else {
                                                                collateralupdate($_SESSION['users'], $_REQUEST['id'], $_REQUEST['mno'], $_REQUEST['descr'], $_REQUEST['idno'], $_REQUEST['value'], $_REQUEST['status'], $_REQUEST['comment'], $image);
                                                            }
                                                        }

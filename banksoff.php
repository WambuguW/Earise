...
$bank = new User();
$users = new Users();
$permission = "reportscontributiongroups";
$page = 'view';
$childpage = 'groups';
?>
<!DOCTYPE html>
	...
	pause: 1000 //<--no comma following last option!
        ...
        <script type="text/javascript">
            function showUser(str)
            {
                ...
                xmlhttp.open("GET", "./search/banksearch.php?q=" + str, true);
                xmlhttp.send();
            }
        </script>
                                        ...
                                        <div class=" col-md-offset-1 col-md-11">
                                            ...
                                            <div class="portlet box green calendar">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="icon-reorder"></i> Add Banking Officer
                                            ...
                                            ?>
                                                            ...
                                                            <?php
                                                                ...
                                                                if (isset($_REQUEST['submit'])) {
                                                                    $bank->banking($_SESSION['users'], $_REQUEST['name'], $_REQUEST['branch'], $_REQUEST['accno'], $_REQUEST['amt'], $_REQUEST['type'], $_REQUEST['approvby'], $_REQUEST['mode'], $_REQUEST['comments'], $_REQUEST['transid'], $_REQUEST['date']);
                                                                }

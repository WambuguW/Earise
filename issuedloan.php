...
<script>
            ...
            , format = function(s, c) {
                ...
                return function(table, name) {
                    ...
                    var ctx = {worksheet: name || 'Issued Loans', table: table.innerHTML}
                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Issued Loans
                                                        ...
                                                        <div class="art-content-layout-row">
                                                            <div class="art-layout-cell" style="width: 100%" >
                                                                ...
                                                                if (isset($_REQUEST['sdate'])) {
                                                                    ...
                                                                    issuedloan($_SESSION['user'], $_REQUEST['datefrom'], $_REQUEST['dateto']);
                                                                
                                                                ?><input type="button" class="btn green" onclick="tableToExcel('sample_2')" value="Export to Excel">
                                                                <button class="btn green" value="Print this page" onClick="return printResults()">Print</button>

                        ...
                        <div class=" col-md-offset-1 col-md-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Banking
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['submit'])) {
                                                      ...
                                                      $bank->banking($_SESSION['users'], $_REQUEST['bankname'], $_REQUEST['branch'], $_REQUEST['accno'], $_REQUEST['amt'],$_REQUEST['mode'], $_REQUEST['approvby'],  $_REQUEST['comments'], $_REQUEST['transid'], $_REQUEST['date'], $_REQUEST['type'],$_REQUEST['status'],$_REQUEST['accFrom']);
                                                }

                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Invoice Vehicle
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            if (isset($_POST['invoice'])) {
                                                ...
                                                $lect->invoiceVehicle(base64_encode($_POST['vid']), base64_encode($_POST['acc']), base64_encode($_POST['date']), base64_encode(getInvoivedAmount($_POST['acc'])));
                                            }
                                            if(isset($_REQUEST['edit'])||  isset($_REQUEST['vehinvdel']) || isset($_REQUEST['update'])  || isset($_REQUEST['vehinvin']) ){
                                            
                                            if(isset($_REQUEST['edit'])){
                                            editViewInvoicedVehicle();
                                            }
                                            if(isset($_REQUEST['vehinvin'])){
                                                invoicedVehicleForm($_REQUEST['vehinvin']);
                                            }
                                            if(isset($_REQUEST['update'])){
                                                updateVehicleInvoice($_POST['id'],base64_encode($_POST['acc']),base64_encode($_POST['vid']),base64_encode($_POST['date']),base64_encode(getInvoivedAmount($_POST['acc'])));
                                            }

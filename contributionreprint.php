                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Reprint  Contribution Receipt
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            if(isset($_REQUEST['request'])  ||isset($_REQUEST['print'])){
                                                
                                                if(isset($_REQUEST['request'])){
                                                    contibutionreceipt($_SESSION['users'],$_REQUEST['mno']);
                                                  
                                            }  //i wil use 11 to check if receipt is duplicate
                                              if(isset($_REQUEST['btnprint'])){
                                                   printcontr($_SESSION['users'],$_REQUEST['print'],"11");

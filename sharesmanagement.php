...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <script type="text/javascript">
                    function  userAccounts(val) {

                    $.ajax({
                    cache: false,
                            type: "GET",
                            url: "./search/userAccounts.php",
                            data: 'q=' + val,
            ...
            function  userAccWithdrawal(val) {
                        ...
                        <div class=" col-md-12 ">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>  Deposits Management
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <ul id="countrytabs" class="nav nav-tabs ">
                                                <li class="active"><a href="#"  data-toggle="tab" rel="country1" >Member To Self</a></li>
                                                <li><a href="#" data-toggle="tab"  rel="country2">Member Withdrawals</a></li>
                                                <li><a href="#" data-toggle="tab" rel="country3">Member To Another</a></li>
                                                <li><a href="#" data-toggle="tab" rel="country6"> Member To Sacco</a></li>
                                            ...
                                            <div class="col-md-12" style=" margin-bottom: 1em; padding: 0px">
                                                ...
                                                <div  class="tabcontent active" id="country1" style=" width:1200px;">
                                                    <?php
                                                    if (isset($_REQUEST['self'])) {
                                                        $newuser->sharestoself($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['mno'], $_REQUEST['apby'], 'NULL', $_REQUEST['facc'], $_REQUEST['tacc'], $_REQUEST['amount'], $_REQUEST['comments'], $_REQUEST['date']);
                                                    }
                                                    sharemembertoself();
                                                    ?>
                                                </div>
                                                ...
                                                <div id="country2" class="tabcontent" style=" width:1200px;">
                                                    ...
                                                    if (isset($_REQUEST['with'])) {
                                                        $newuser->shareswithdrawal($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['mno'], $_REQUEST['apby'], 'NULL', $_REQUEST['facc'], $_REQUEST['amount'], $_REQUEST['comments'], $_REQUEST['date']);
                                                    }
                                                    withdrawmemberform();
                                                    ?>
                                                </div>
                                                ...
                                                <div id="country3" class="tabcontent" style=" width:1200px;">
                                                    ...
                                                    if (isset($_REQUEST['another'])) {
                                                        $newuser->sharesmembertomember($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['from'], $_REQUEST['to'], $_REQUEST['apby'], 'NULL', $_REQUEST['facc'], $_REQUEST['tacc'], $_REQUEST['amount'], $_REQUEST['date'], $_REQUEST['comments']);
                                                    }
                                                    sharemembertoanother();
                                                    ?>
                                                </div>
                                                <div id="country6" class="tabcontent" style=" width:1200px;">
                                                    <?php
                                                    if (isset($_REQUEST['sacco'])) {
                                                        $newuser->sharestosacco($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['mno'], $_REQUEST['apby'], 'NULL', $_REQUEST['facc'], $_REQUEST['tacc'], $_REQUEST['amount'], $_REQUEST['date'], $_REQUEST['comments']);
                                                    }
                                                    sharestosacco();
                                                    ?>

                                        ...
                                        <div class=" col-md-offset-1 col-md-11">
                                            ...
                                            <div class="portlet box green calendar">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="icon-reorder"></i> Asset Manager
...
<?php
    ...
    if (isset($_REQUEST['acid']) || isset($_REQUEST['accedit']) || isset($_REQUEST['ace'])) {
        ...
        glaccedit($_SESSION['user'], $rows['id'], base64_decode($rows['accode']), base64_decode($rows['acname']), base64_decode($rows['accgroup']));
    }
    if (isset($_REQUEST['ace'])) {
        glaccountsupdate($_SESSION['user'], $_REQUEST['id'], $_REQUEST['acode'], $_REQUEST['acname'], $_REQUEST['acgroup'], $_REQUEST['status']);
    }

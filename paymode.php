                ...
                <div class="col-md-offset-1 col-md-10 col-sm-10">
                    ...
                    <div class="portlet box green calendar">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-reorder"></i> Add Payment Mode
                        ...
                        <div class="portlet-body dark_green" style="color:#000000">
                            <div class="well dark_green">
                                ...
                                <div class="art-layout-cell art-content clearfix">
                                    ...
                                    <!------form start----->
                               <?php
                                            if (isset($_POST['submit202'])) {
                                                $addMode->addmode($_SESSION['users'], base64_encode($_POST['mode']), base64_encode($_POST['status']));
                                            }
                                            if(isset($_REQUEST['edit'])|| isset($_REQUEST['modid'])  ||  isset($_REQUEST['edit'])  || isset($_REQUEST['update'])|| isset($_REQUEST['model'])){
                                            
                                                if( isset($_REQUEST['modid'])){
                                                    editpaymode($_REQUEST['modid']);
                                                }
                                                if(isset($_REQUEST['update'])){
                                                    updatePaymentMode(base64_encode($_POST['mode']), base64_encode($_POST['status']),$_REQUEST['id']);
                                                }

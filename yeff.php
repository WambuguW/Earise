...
echo '<div id="mt"><table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                                     <thead>
                                                     <tr><th colspan="9"><h3 align="center"><b> Next of Kin Reports   </b></h3></th></tr>
                                                     <tr>
                                                     <th>Member Number</th>
                                                     <th>Member Name</th>
...
$qry = mysql_query('select * from nextofkin order by memberno') or die(mysql_errno());
while ($row = mysql_fetch_array($qry)) {
    ...
    echo '<tr>
              ...
              <td>' . base64_decode($row['mobile']) . '</td>
                  <td>' . ucwords(strtolower(base64_decode($row['comments']))) . '</td></tr>';
}

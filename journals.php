                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Journals
                                            ...
                                            <div class="tabbable-custom ">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab_5_1">
                                                        ...
                                                        <button class="btn green" value = "Print this page" onClick="return printResults1()">Print</button>
...
?>
                                                    ...
                                                    <div class="tab-pane" id="tab_5_2">
                                                        ...
                                                        if ($_SESSION['datefrom']) {
                                                            ...
                                                            <div class="col-md-4">    
                                                                <button class="btn green" value = "Print this page" onClick="return printResults2()">Print</button>

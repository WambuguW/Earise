...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.0.0.58475 -->
        <meta charset="utf-8">
        <title>Contribution Group Statement</title>
    ...
    <?php
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                ...
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon"> Contribution Groups Statements</span></h2>
  <div class="noprint">
                                    <!------form start----->
                                    <?php
                                                        ...
                                                        <div class="art-layout-cell" style="width: 100%" >
                                                            <div class="simpleTabs">
                                                                ...
                                                                <div class="simpleTabsContent">
                                                                    <?php
                                                                    minidyna($_SESSION['users'], $_REQUEST['mno'], $_REQUEST['acc'], $_REQUEST['dfrom'], $_REQUEST['mfrom'], $_REQUEST['yfrom'], $_REQUEST['dto'], $_REQUEST['mto'], $_REQUEST['yto']);
                                                                    ?>
                                                                      <div class="noprint">

                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            //$ok = 0;
                                            $newuser->addcrew($_SESSION['users'], $_REQUEST['name'], $_REQUEST['id'], $_REQUEST['mobile'], $_REQUEST['date'], $_REQUEST['status'], $_REQUEST['residence'], $_REQUEST['job'], $_REQUEST['email'], $image);
                                            } else {
                                            $newuser->addcrew($_SESSION['users'], $_REQUEST['name'], $_REQUEST['id'], $_REQUEST['mobile'], $_REQUEST['date'], $_REQUEST['status'], $_REQUEST['residence'], $_REQUEST['job'], $_REQUEST['email'], $image);
                                            }
                                            }

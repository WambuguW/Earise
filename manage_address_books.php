                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Manage Address Book
...
<table class="table table-striped table-bordered">
                                                ...
                                                <th colspan="2">MY ADDRESS BOOKS</th>
                                                    </tr>
                                                    <tr>
                                                        <th>
                                                            Address Book                                                            
                                                    ...
                                                    <?php
                                                            ...
                                                            $sth=mysql_query(" SELECT * FROM addressbooks GROUP BY name  ");
                                                            while($addressBooks = mysql_fetch_array($sth)){
                                                                $addBookName = base64_decode($addressBooks['name']);
                                                                
                                                                echo "<tr>"
                                                                . "<td>" ."<input style='border: none; cursor: default' type='text'class='form-control' name='addressbk' value='" .$addBookName ."' readonly='true'>" 
                                                                        ."</td>"
                                                                       
                                                                . "<td>" . "<a href=\"manage_address_books.php?del=".$addressBooks['id']."\" OnClick=\"return confirm('Are you sure that you want to delete this address book?');\"title='Delete addressbook' style='cursor: default' class='del'>".'<img src="images/delete.png">' .'</a>'."</td>" ."</tr>";

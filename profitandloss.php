                        ...
                        <div class=" col-md-12">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Profit And Loss Statement(Income Statement)
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="art-layout-cell" style="width: 100%" >
                                                             ...
                                                             if(isset($_REQUEST['sdate'])){
                                                                profitandlosexpenseform($_SESSION['users'], $_REQUEST['datefrom'], $_REQUEST['dateto']);

                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Register Vehicle
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['submit'])) {
                                                    $newv->registervehicle($_REQUEST['mno'], $_REQUEST['regno'], $_REQUEST['logbookno'], $_REQUEST['vvalue'], $_REQUEST['purchasedate'], $_REQUEST['vehicletype'], $_REQUEST['routes'], $_REQUEST['capacity'], $_REQUEST['comments'], $_REQUEST['fleet'], $_REQUEST['nickname'], $_REQUEST['dri'], $_REQUEST['cond'], $_REQUEST['comments']);
                                                }
                                                vehicleregistration();

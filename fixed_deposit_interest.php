                        ...
                        <div class=" col-md-offset-1 col-md-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Accrue interest on fixed deposit
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <?php 
                                        if($users->permissions($_SESSION['users'], basename($_SERVER['PHP_SELF'])) === 1 ){
                                            //accrue fixed deposit interest
                                             $newuser-> FixedDepoInterestAccrual();
                                              //when run it posts the accrued interest to given members
                                             $newuser-> postFixed_depoAccruedInterest();
                                            //management fee
                                             $newuser->FixedDepoManagementFee();
                                         }else{

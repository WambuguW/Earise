                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Not Disbursed Loans
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <!------form start----->
                                            <?php
                                            if ($users->permissions($_SESSION['users'], basename($_SERVER['PHP_SELF']))) {
                                              
                                                notDisbursedLoans();
                                              
                                                   
                                                ?>
                                                <div class="col-md-4"><input type="button" class="btn green" onClick="return printResults()" value="print">
                                                   <input type="button" class="btn green" onclick="tableToExcel('sample_2')" value="Export to Excel"></div>
                                                  <!--<a id="word" class="btn green" > Export To Word </a> -->
                                                        <?php
                                               // loansexport();
                                            } else {

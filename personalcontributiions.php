                                        ...
                                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                                            ...
                                            <div class="portlet box green calendar">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="icon-reorder"></i> Personal Contributions
                                            ...
                                            ?>
                                                            ...
                                                            <!------form start----->
                                                                ...
                                                                <form action="" method="post">
                                                                    <div class="searcher">
                                                                        <div class="col-md-4">
                                                                            <input type="text" class="form-control" name="mysearch" autofocus required="required" title="Enter Member Number to search" placeholder="Enter Member Number to search" onkeyup="showUser(this.value)"/>
                                                                        </div></div>
                                                                </form>
                                                                <div id="txtHint"></div>

                ...
                <div class="col-md-offset-1 col-md-10 col-sm-10">
                    ...
                    <div class="portlet box green calendar">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-reorder"></i> Add Organisation 
                            ...
                            <div class="well dark_green">
                                ...
                                <div class="art-layout-cell art-content clearfix">
                                    ...
                                    <?php
                                        ...
                                        if (isset($_REQUEST['addorg'])) {
                                            $addOrg->insertOrganisation(base64_encode($_REQUEST['org']), base64_encode($_REQUEST['status']));
                                        }
                                        if (isset($_REQUEST['edit']) || isset($_REQUEST['orged']) || isset($_REQUEST['orgdel'])) {

                                            if (isset($_REQUEST['edit'])) {
                                                editOrganisation();
                                            }
                                            if (isset($_REQUEST['orged'])) {
                                                addOrganisationForm($_REQUEST['orged']);
                                                $id = ($_REQUEST['orged']);
                                                $sth = mysql_query("SELECT *  FROM   organisation WHERE  id='" . $id . "'");
                                                while ($row = mysql_fetch_array($sth)) {
                                                    $oldname = base64_decode($row['organisation']);
                                                    $oldstatus = base64_decode($row['status']);
                                                }
                                            }
                                            if (isset($_REQUEST['update'])) {

                                                updateOrgasation(base64_encode($_REQUEST['org']), base64_encode($_REQUEST['status']), $_REQUEST['id'], $oldname, $oldstatus);
                                            }

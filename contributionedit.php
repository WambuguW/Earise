...
echo "<div class='two'>"
 ...
 . "<select name='tname[]' required title='Payment type'><option></option>";
                        ...
                        <div class=" col-md-12 ">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Contribution Edit
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['edit']) || isset($_REQUEST['btnedit']) || isset($_REQUEST['btnupdate']) || isset($_REQUEST['cdel']) || isset($_REQUEST['request'])) {

                                                    if (isset($_REQUEST['btnedit'])) {

                                                        $id = $_REQUEST['cid'];

                                                        $sql = mysql_query('SELECT * FROM membercontribution WHERE primarykey="' . $id . '"') or die(mysql_error());

                                                        $rows = mysql_fetch_array($sql);


                                                        editcontribution($_SESSION['users'], $rows['primarykey'], base64_decode($rows['memberno']), base64_decode($rows['payeeid']), base64_decode($rows['payee']), base64_decode($rows['datefrom']), base64_decode($rows['dateto']), base64_decode($rows['amount']), base64_decode($rows['date']), ($rows['session']), base64_decode($rows['bnkid']), $rows['paymenttype']);
                                                    }
                                                    if (isset($_REQUEST['btnupdate'])) {

                                                         contiupdate($_SESSION['users'], $_REQUEST['id'], $_REQUEST['mno'], $_REQUEST['payeeid'], $_REQUEST['payee'], $_REQUEST['datefrom'], $_REQUEST['bankname'], $_REQUEST['datett'], $_REQUEST['ptype'], $_REQUEST['amount'], $_REQUEST['date'], $_REQUEST['session']);
                                                    }

                                                    if (isset($_REQUEST['cdel'], $_REQUEST['amount'], $_REQUEST['date'])) {
                                                        include ('del.php');
                                                    }
                                                    if (isset($_REQUEST['request'])) {
                                                        contiedit($_REQUEST['mno']);
                                                    }
                                                } else {
                                                    form();
                                                }

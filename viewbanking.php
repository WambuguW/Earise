                        ...
                        <div class=" col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Banking Reports
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                        ...
                                                        echo '
                                                            <form method="post" action="reconsiliationDate.php">                                                            
                                                            <div class="col-md-2">Select Bank</div>
                                                            <div class="col-md-3">
                                                            <select name="bank" class="form-control" name="bank">';
                                                            $banks = mysql_query('select * from addbank');
                                                    while($row = mysql_fetch_array($banks))
                                                    {
                                                    ...
                                                    echo '</select>
                                                        ...
                                                        <div class="col-md-2">
                                                        <input type="submit" name="proceed" class="btn green" value="Proceed">
                                                        </div>

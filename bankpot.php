                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Banking Statements
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix
                                            ...
                                            <?php
                                                ...
                                                dailyform();
                                                bankstatements($_SESSION['users'], $_REQUEST['datefrom'], $_REQUEST['dateto']);
                                                ?>
                                               <div class="col-md-4">
                                                ...
                                                if (isset($_REQUEST['dai'])) {
                                                    header('location:export.php?datefrom=' . $_REQUEST['dfrom'] . '&dateto=' . $_REQUEST['dateto'] . '&dai=' . $_REQUEST['dai'] . '');
                                                    ?>
                                                <div class="col-md-4">
                       <input type="button" class="btn green" onclick="tableToExcel('sample_2')" value="Export to Excel">

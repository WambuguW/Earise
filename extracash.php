                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['submit']) || isset($_REQUEST['lid'])) {

                                                    if (isset($_REQUEST['submit'])) {

                                                        $newuser->addextracash($_SESSION['users'], $_REQUEST['mno'], $_REQUEST['tid'], $_REQUEST['loant'], $_REQUEST['fee'], $_REQUEST['amount']);
                                                    }

                                                    if (isset($_REQUEST['lid'])) {

                                                        extracashform($_SESSION['users'], $_REQUEST['lid'], $_REQUEST['tid']);
                                                    }
                                                } else {

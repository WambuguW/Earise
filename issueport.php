                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Debtors Report
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            if (isset($_REQUEST['msubmit'])) {
                                                    ...
                                                    agedebtors($_SESSION['users'], $_REQUEST['datefrom'], $_REQUEST['dateto']);
                                                    ?>

                                                    <div class="col-md-offset-4"> 

                                                        <button type="button" class="btn green" onclick="tableToExcel('sample_2')" value="Export to Excel">Export To Excel </button>    

...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <script>
                                                        ...
                                                        xmlhttp.open("GET", "invsearch.php?q=" + str, true);
                                                                xmlhttp.send();
                                                        }
        </script>
    </head>
                        ...
                        <div class=" col-md-offset-1 col-md-11">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Bank Payments
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['acsubmit'])) {
                                                    $glacc = '';
                                                    $newuser->bpayments($_SESSION['users'], $_REQUEST['bankid'], $_REQUEST['rece'], $_REQUEST['creditor'], $_REQUEST['glcode'], $glacc, $_REQUEST['check'], $_REQUEST['descrr'], $_REQUEST['amount'], $_REQUEST['date'], $_REQUEST['transid'], $_REQUEST['ptype']);
                                                }

                                                if (isset($_REQUEST['gid']) || isset($_REQUEST['gedit']) || isset($_REQUEST['save']) || isset($_REQUEST['debdel'])) {

                                                    if (isset($_REQUEST['gid'])) {

                                                        $id = $_REQUEST['gid'];

                                                        $sql = mysql_query('SELECT * FROM addebtor WHERE id="' . $id . '"') or die(mysql_error());

                                                        $rows = mysql_fetch_array($sql);

                                                        debtorsedit($rows['id'], base64_decode($rows['dname']), base64_decode($rows['address']), base64_decode($rows['dcont']), base64_decode($rows['demail']), base64_decode($rows['kra']), base64_decode($rows['terms']), base64_decode($rows['creditstatus']), base64_decode($rows['status']));
                                                    }

                                                    if (isset($_REQUEST['save'])) {
                                                        debtorupdate($_SESSION['users'], $_REQUEST['id'], $_REQUEST['dname'], $_REQUEST['address'], $_REQUEST['dcont'], $_REQUEST['demail'], $_REQUEST['kra'], $_REQUEST['terms'], $_REQUEST['creditstatus'], $_REQUEST['status']);
                                                    }

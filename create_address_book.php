          ...
          $('.parent').on('click', function() {
            ...
            function showUser(str) {
                if (str == "") {
                    ...
                    xmlhttp.open("GET", "search/getAddressBook.php?q=" + str, true);
                    xmlhttp.send();
                }
            }
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Create address Book
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        if(isset($_POST['addBook'])){
                                          ...
                                          $lect ->insertAddressBook(base64_encode($no),memberNo(base64_encode($no)),  base64_encode($_POST['name']));
                                        }
                                        }
                                        createAddressBook();
                                        ?>

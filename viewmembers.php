...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <script>
                    function printResults22() {
                    var content = document.getElementById('mt22').innerHTML;
                            var pwin = window.open('', 'print_content', 'width=200,height=200');
                            pwin.document.open();
                            pwin.document.write('<html><link rel="stylesheet" href="assets/plugins/bootstrap/css/bootstrap.min.css"><body style="font-family:Arial, Helvetica, sans-serif; font-size:8px; text-align:center; margin-right:5%; margin-left:5%; width:90%; background-color:#FFF;" onload="window.print()">' + content + '</body></html>');
                            pwin.document.close();
        ...
        <script>
                    function printResults32() {
                    var content = document.getElementById('mt32').innerHTML;
                            var pwin = window.open('', 'print_content', 'width=200,height=200');
                            pwin.document.open();
                            pwin.document.write('<html><link rel="stylesheet" href="assets/plugins/bootstrap/css/bootstrap.min.css"><body style="font-family:Arial, Helvetica, sans-serif; font-size:8px; text-align:center; margin-right:5%; margin-left:5%; width:90%; background-color:#FFF;" onload="window.print()">' + content + '</body></html>');
                            pwin.document.close();
        ...
        <script>
                    function printResults42() {
                    var content = document.getElementById('mt42').innerHTML;
                            var pwin = window.open('', 'print_content', 'width=200,height=200');
                            pwin.document.open();
                            pwin.document.write('<html><link rel="stylesheet" href="assets/plugins/bootstrap/css/bootstrap.min.css"><body style="font-family:Arial, Helvetica, sans-serif; font-size:8px; text-align:center; margin-right:5%; margin-left:5%; width:90%; background-color:#FFF;" onload="window.print()">' + content + '</body></html>');
                            pwin.document.close();
        ...
        <script>
                    function printResults52() {
                    var content = document.getElementById('mt52').innerHTML;
                            var pwin = window.open('', 'print_content', 'width=200,height=200');
                            pwin.document.open();
                            pwin.document.write('<html><link rel="stylesheet" href="assets/plugins/bootstrap/css/bootstrap.min.css"><body style="font-family:Arial, Helvetica, sans-serif; font-size:8px; text-align:center; margin-right:5%; margin-left:5%; width:90%; background-color:#FFF;" onload="window.print()">' + content + '</body></html>');
                            pwin.document.close();
                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Members Reports
                                                    ...
                                                    <div class="tab-content">
                                                       ...
                                                       <div class="tab-pane" id="tab_5_2">
                                                        ...
                                                        <div class="tab-pane" id="tab_5_3">
                                                            ...
                                                            viewinactivemembers();
                                                            ?>
                                                            <!--<div class="col-md-4"><input type="button" class="btn green" onclick="tableToExcel('sample')" value="Export to Excel"></div>-->
                                                            <?php
                                                           exportinactivemember();
                                                            ?>
                                                        </div>
                                                        ...
                                                        <div class="tab-pane" id="tab_5_5">
                                                            ...
                                                            ?>
                                                            <div class="col-md-4"><input type="button" class="btn green" onclick="tableToExcel('testTable')" value="Export to Excel"></div>
                                                        </div><div class="tab-pane" id="tab_5_6">
                                                            <?php
                                                            viewwithdrawnmember();
                                                            ?>
                                                            <!--<div class="col-md-4"><input type="button" class="btn green" onclick="tableToExcel('withdrawn')" value="Export to Excel"></div>--->
                                                            <?php
                                                           exportwithdrawnmember();
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>

                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Check Off Edit
                                ...
                                <div class="portlet-body dark_green" style='color:#000000; ' >
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            if ( (isset($_POST['search']))  ||  (isset($_REQUEST['btnchek']))  || (isset($_REQUEST['insert'])) )   {
                                                
                                                if(isset($_POST['search'])){
                                                   editCheckOffReport($_POST['mnth'], $_POST['org']); 
                                                }
                                                if(isset($_REQUEST['btnchek'])){
                                                  updateCheckOff($_REQUEST['che']);  
                                                }
                                                if(isset($_REQUEST['insert'])){
                                                   upCheckOff($_REQUEST['amount'],$_REQUEST['id']); 
                                                }

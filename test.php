...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <script type="text/javascript">
            function viewmemberloan(str)
            {
                ...
                xmlhttp.onreadystatechange = function()
                {
                    ...
                    {
                        document.getElementById("viewmemberloan").innerHTML = xmlhttp.responseText;
                    }
                }
                xmlhttp.open("GET", "./search/memberloans.php?q=" + str, true);
                xmlhttp.send();
            }
        </script>
        <script type="text/javascript">
            function guarantors(str)
            {
                ...
                xmlhttp.onreadystatechange = function()
                {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
                    {
                        document.getElementById("guarantors").innerHTML = xmlhttp.responseText;
                    }
                }
                xmlhttp.open("GET", "./search/personalguaranteed.php?q=" + str, true);
                xmlhttp.send();
            }
        </script>
        <script type="text/javascript">
            function guranteed(str)
            {
                ...
                xmlhttp.onreadystatechange = function()
                {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
                    {
                        document.getElementById("guranteed").innerHTML = xmlhttp.responseText;
                    }
                }
                xmlhttp.open("GET", "./search/memberguaranteed.php?q=" + str, true);
                xmlhttp.send();
            }
        </script>
        <script>
          ...
          <script>
            function printResultsf()
            {

                var content = document.getElementById('mtt').innerHTML;
                var pwin = window.open('', 'print_content', 'width=200,height=200');
                pwin.document.open();
                pwin.document.write('<html><link rel="stylesheet" href="assets/plugins/bootstrap/css/bootstrap.min.css"><body style="font-family:Arial, Helvetica, sans-serif; font-size:8px; text-align:center; background-color:#FFF;" onload="window.print()">' + content + '</body></html>');
                pwin.document.close();
        ...
        <script>
            function printResultsd()
            {

                var content = document.getElementById('mt1').innerHTML;
                var pwin = window.open('', 'print_content', 'width=200,height=200');
                pwin.document.open();
                pwin.document.write('<html><link rel="stylesheet" href="assets/plugins/bootstrap/css/bootstrap.min.css"><body style="font-family:Arial, Helvetica, sans-serif; font-size:8px; text-align:center; background-color:#FFF;" onload="window.print()">' + content + '</body></html>');
                pwin.document.close();
        ...
        <script>
            function printResultsdd()
            {

                var content = document.getElementById('mt2').innerHTML;
                var pwin = window.open('', 'print_content', 'width=200,height=200');
                pwin.document.open();
                pwin.document.write('<html><link rel="stylesheet" href="assets/plugins/bootstrap/css/bootstrap.min.css"><body style="font-family:Arial, Helvetica, sans-serif; font-size:8px; text-align:center; background-color:#FFF;" onload="window.print()">' + content + '</body></html>');
                pwin.document.close();
                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Personal Loan   Statements
                                    </div>
                                    <div class="tools">
                                                ...
                                                <div class="tabbable-custom ">
                                                    ...
                                                    <input type="button" class="btn green" onclick="tableToExcel('sample_2')" value="Export to Excel">
                                                        ...
                                                        <div class="tab-pane" id="tab_5_4">
                                                            ...
                                                            <?php 
                                                            if (isset($_REQUEST['tid'])) {
                                                            personalloanguranteed($_REQUEST['tid']);
                                                            }
                                                            ?>
                                                    <input type="button" class="btn green" onclick="tableToExcel('sample')" value="Export to Excel">
                                                        </div>

                                                        <div class="tab-pane" id="tab_5_5">
                                                            <?php 
                                                             if (isset($_REQUEST['tid'])) {
                                                            membersguranteed($_REQUEST['tid']); 
                                                             }
                                                             ?>

                                                    <input type="button" class="btn green" onclick="tableToExcel('sampl')" value="Export to Excel">

                        ...
                        <div class=" col-md-12 ">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Edit Next of Kin
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            if(isset($_REQUEST['update'])){
                                                if($_REQUEST['rela']!=''){
                                                                ...
                                                                if($new_total>100){
                                                                    echo '<div style="color: red">That member\'s percentage for next of kin will be '.$new_total.'% after this entry, which is greater than 100%!</div>';
                                                                }
                                            ...
                                            //$ok = 0;
                                            updateKin($_REQUEST['mno'], $_REQUEST['fname'], $_REQUEST['mname'], $_REQUEST['lname'], $relationship,  $_REQUEST['dob'],$_REQUEST['percentage'], $_REQUEST['idno'], $_REQUEST['mobile'], $image, $_REQUEST['comments'], $_REQUEST['id']);
                                            } else {
                                            updateKin($_REQUEST['mno'], $_REQUEST['fname'], $_REQUEST['mname'], $_REQUEST['lname'], $relationship, $_REQUEST['dob'],$_REQUEST['percentage'], $_REQUEST['idno'], $_REQUEST['mobile'], $image, $_REQUEST['comments'], $_REQUEST['id']);
                                            }
                                            }

                        ...
                        <div class=" col-md-8 col-md-offset-2 ">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Loan Details Upload
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                            if (isset($_REQUEST['loanpayupload'])) {
                                                    ...
                                                    if (!in_array($file_extension, $file_format)) {
                                                        ...
                                                        do {
                                                            ...
                                                            if ($data[0]) {
                                                                ...
                                                                $newuser->loanpayupload(addslashes($data[0]), addslashes($data[1]), addslashes($data[2]), addslashes($data[3]), $_SESSION['sess'], addslashes($data[4]), addslashes($data[5]), addslashes($data[6]), addslashes($data[7]), addslashes($data[8]));
                                                            }
                                            ...
                                            //if user uploaded the loan interest details
                                            if (isset($_REQUEST['loaninterestupload'])) {
                                                if ($_FILES[csv][size] > 0) {
                                                    ...
                                                    if (!in_array($file_extension, $file_format)) {
                                                        ...
                                                        do {
                                                            ...
                                                            if ($data[0]) {
                                                                ...
                                                                $newuser->loaninterestupload(addslashes($data[2]), addslashes($data[5]), addslashes($data[4]), base64_encode('active'), addslashes($data[1]), addslashes($data[0]), addslashes($data[7]),addslashes($data[3]), addslashes($data[6]), $_SESSION['sess'], addslashes($data[8]));
                                                            }
                                                        } while ($data = fgetcsv($handle, 1000, ",", "'"));
                                                        /* ------------- End of inserting data ---------------------------- */
                                            ...
                                            if (!isset($_REQUEST['submit']) && (!isset($_REQUEST['importcsv']))) {
                                                ...
                                                loandetailsform(); //this function calls the functions below
                                               // contibution();

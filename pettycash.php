                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Petty Cash Expenses
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['submit'])) {
                                                    $newuser->saccopettyexpense($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['tname'], $_REQUEST['res'], $_REQUEST['ptype'], $_REQUEST['cheque'], $_REQUEST['apby'], $_REQUEST['date'], 'NULL', $_REQUEST['reason'], $_REQUEST['recvr'], $_REQUEST['recvrid'], $_REQUEST['comments'], $_SESSION['sess'], $_REQUEST['submit'],$_REQUEST['bankname']);
                                                }

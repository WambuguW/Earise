                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Member Groups
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['create'])) {
                                                    ...
                                                    $newuser->creategroup($_SESSION['users'], $_REQUEST['gname'], $_REQUEST['status'], $_REQUEST['comment']);
                                                }
                                                ...
                                                if (isset($_REQUEST['gid']) || isset($_REQUEST['gedit']) || isset($_REQUEST['save']) || isset($_REQUEST['gdel'])) {
                                                    ...
                                                    if (isset($_REQUEST['gid'])) {
                                                        ...
                                                        $sql = mysql_query('SELECT * FROM cgroup WHERE id="' . $id . '"') or die(mysql_error());

                                                        $rows = mysql_fetch_array($sql);

                                                        groupedit($rows['id'], base64_decode($rows['gname']), base64_decode($rows['status']), base64_decode($rows['comment']));
                                                    }

                                                    if (isset($_REQUEST['save'])) {
                                                        groupupdate($_SESSION['users'], $_REQUEST['id'], $_REQUEST['gname'], $_REQUEST['status'], $_REQUEST['comment']);
                                                    }

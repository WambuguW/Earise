                        ...
                        <div class="col-md-10 col-md-offset-1 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Check  Off
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                            if (isset($_POST['finish']) || isset($_POST['check'])) {
                                               
                                                if (isset($_POST['finish'])) {
                                                   // ECHO $AmountAcount=count($_POST['AmountAcount']);
                                                   // $mno=  $_POST['mno'];
                                                  $mno= ($_POST['check']);
                                                  foreach ($mno as $memberNumber) {
                                                     $allAccount = $_POST[$memberNumber];
                                                     
                                                      foreach($allAccount as  $account){
                                                        
                                                        $mempos=$memberNumber.$account;
                                                       $allAmount = $_POST[$mempos];
                                                       
                                                      foreach($allAmount as  $amount){
                                                         //echo "memb".$memberNumber.'<br>';
                                                         //echo 'accou'.$account.'<br>';
                                                         // echo "amount". $amount.'<br>';
                                                          if($amount>0){
                                                           $date = date('d-M-Y');
                                                          
                                                        $lect->insertIntoCheck(base64_encode($memberNumber), base64_encode($_POST['org']), base64_encode($_POST['mnth']), base64_encode($account), base64_encode($amount), base64_encode($date));
                                                      }
                                                      } 
                                                      
                                                             //$date = date('d-M-Y');
                                                            //$lect->insertIntoCheck(base64_encode($memberNumber), base64_encode($_POST['org']), base64_encode($_POST['mnth']), base64_encode($tid), base64_encode($amount), base64_encode($date));
                                                ...
                                                if (isset($_POST['check'])) {
                                                    ...
                                                    completeCheckoff($_POST['org'], $_POST['mnth']);
                                                }
                                            } else {
                                                checkOff();
                                            }

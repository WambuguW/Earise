                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Trial Balance</span></h2>
                                    <?php
                                    ...
                                    <div class="art-postcontent art-postcontent-0 clearfix">  
                                      ...
                                      tbalance($_SESSION['users'], $_SESSION['dfrom'], $_SESSION['mfrom'], $_SESSION['yfrom'], $_SESSION['dto'], $_SESSION['mto'], $_SESSION['yto']);
                                                    }

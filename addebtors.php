                        ...
                        <div class=" col-md-offset-1 col-md-11">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Add Debtors
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['create'])) {
                                                    ...
                                                    $newuser->addebtors($_SESSION['users'], $_REQUEST['dname'], $_REQUEST['address'], $_REQUEST['dcont'], $_REQUEST['demail'], $_REQUEST['kra'], $_REQUEST['terms'], $_REQUEST['creditstatus']);
                                                }

...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            xmlhttp.open("GET", "./search/loandelsearch.php?q=" + str, true);
                    xmlhttp.send();
            }
        </script>
        <!-- SimpleTabs -->
                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Loan Reversal
                                            ...
                                            <?php
                                                ...
                                                <div class="noprint">
                                                    <form action="" method="post">
                                                        ...
                                                        <div class="searcher">
                                                            <?php
                                                            echo '<select name = "mno" id="select2_sample4" onchange = "showUser(this.value)" required placeholder = "Search Member No. or Name" title = "Search Member No. or Name"  class="input-medium form-control select2  ">
    <option></option>';
                                                    ...
                                                    <div class="art-content-layout">
                                                        <div class="art-content-layout-row">
                                                            <div class="art-layout-cell" style="width: 100%" >
                                                                ...
                                                                <?php
                                                                loanreverse($_REQUEST['tra_id'], $_REQUEST['mno']);
                                                                ?>
                                                            </div>
                                                        </div>
                                                    </div>

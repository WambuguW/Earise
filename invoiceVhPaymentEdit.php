                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>Edit Vehicle Payment 
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <!------form start----->
                                            <?php
                                            if (isset($_REQUEST['invid']) ||isset($_REQUEST['invdel'])  || isset($_POST['payinvoice']) ){
                                                  if (isset($_REQUEST['invdel'])) {
                                                        include ('del.php');
                                                    }
                                                  if(isset($_REQUEST['invid'])) {
                                                    formInvoicePaymentVehicle($_REQUEST['invid']);  
                                                  } 
                                                  if(isset($_POST['payinvoice'])){
                                                     updateVehiclePaymentInvo ( $_POST['id'] ,base64_encode($_POST['acc']), base64_encode($_POST['vid']),  vehicleOwner($_POST['vid']), base64_encode($_POST['payee']), base64_encode($_POST['amount']), base64_encode($_POST['date']));
                                                  }
                                            }else{

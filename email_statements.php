                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Members' Statements
...
<div class="col-md-8">
						...
						<div class="input-group">							
                                                ...
                                                <input type="hidden" name="dateto" value="<?php echo $_POST['dateto']?>">
                                                    <select name="statement" style="margin-top: 5px" class="form-control input-medium">
                                                        <option value="1">Contributions statements</option>
                                                        <option value="2">Shares Statements</option>
                                                <option value="3">Loan Statements</option>
                                                <option value="4">Member Income to Sacco</option>
                                            </select>
</div>
                                                                                                                <button style="margin-top: 5px" type="submit" class="btn blue">Generate</button>
</div></form>
                                            <?php
                                            }else{

                        ...
                        <div class=" col-md-12 col-sm-12">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Income Edit
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                //max
                                                    ...
                                                    if (isset($_REQUEST['edit']) || isset($_REQUEST['btnedit']) || isset($_REQUEST['btnupdate']) || isset($_REQUEST['idel']) || isset($_REQUEST['sdate']) ) {
                                                    ...
                                                    if (isset($_REQUEST['btnedit'])) {
                                                        ...
                                                        editincome($_SESSION['users'], $rows['primarykey'], base64_decode($rows['paidby']), base64_decode($rows['payeeid']), base64_decode($rows['approvedby']), base64_decode($rows['comments']), base64_decode($rows['amount']), base64_decode($rows['date']), base64_decode($rows['transid']),base64_decode($rows['paymentype']), base64_decode($rows['session']),  base64_decode($rows['bnkid']));	
                                                    }
                                                    
                                                
                                                    if (isset($_REQUEST['btnupdate'])) {
                                                        
                                                       incomeupdate($_SESSION['users'], $_REQUEST['id'], $_REQUEST['payee'], $_REQUEST['pid'], $_REQUEST['apby'], $_REQUEST['comments'], $_REQUEST['tname'], $_REQUEST['ptype'], $_REQUEST['res'], $_REQUEST['date'], $_REQUEST['tid'], $_REQUEST['session'],$_POST['bankname']);
                                                    }

                                                    if (isset($_REQUEST['idel'], $_REQUEST['amount'], $_REQUEST['date'])) {
                                                        include ('del.php');
                                                    }
                                                if(isset($_REQUEST['sdate'])){
                                                incomeedit($_REQUEST['datefrom'],$_REQUEST['dateto']);

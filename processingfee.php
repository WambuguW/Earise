...
document.getElementById('text').innerHTML += "<div class='form-group'><div class='col-md-12'> <div class='col-md-4'><label class='control-label'>Amount From </label>   <input type='text' name='amtfrom[]' class='form-control input-medium' title='Enter Amount To' required placeholder='Enter Amount To'  /> </div><div class='col-md-4'> <label class='control-label'> Amount To</label>  <input type='text' name='amtto[]'required class='form-control input-medium' title='Enter Amount From'  placeholder='Enter Amount From'  />  </div>     <label class='control-label'>Amount </label> <br/>    <input type='text' name='amount[]' required class='form-control input-medium' title='Enter Amount'  placeholder='Enter Amount '  /></div></div>";
fields += 1;
alert(fields);
         $("#receipt").html(fields);
         document.getElementById("demo").innerHTML = fields;
} else {
document.getElementById('text').innerHTML += "<br />Only 17 add input allowed.";
                ...
                <div class=" col-md-10 col-sm-10 col-md-offset-1">
                    ...
                    <div class="portlet box green calendar">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-reorder"></i> Processing Fees Settings
                                ...
                                <div class="art-layout-cell art-content clearfix">
                                    ...
                                    if(isset($_REQUEST['me'])){
                                        for($i=0; $i< count($_REQUEST['amount']);$i++){
                                            ...
                                            $amtfrom=$_REQUEST['amtfrom'][$i];
                                           $amtto=$_REQUEST['amtto'][$i];
                                            $amount=$_REQUEST['amount'][$i];
                                            
                                      $users -> insertIntoPro($_REQUEST['lname'],$amtfrom,$amtto,$amount);
                                        }
                                    }
                                    loanProcssingFees();

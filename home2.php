...
<html lang="en" class="no-js">
    ...
    <!-- END HEAD -->
    <!-- BEGIN BODY -->
    <body class="page-header-fixed page-full-width" style="font-family: verdana; font-size:14px; ">
        <!-- BEGIN HEADER -->
        <div class="header navbar navbar-fixed-top mega-menu">
            <!-- BEGIN TOP NAVIGATION BAR -->
            <div class="header-inner" >
                <!-- BEGIN LOGO -->
                <a class="navbar-brand" href="index.html" style="width:90px; height:50px;">
                    <img src="assets/img/logo1.jpg"  alt="logo" class="img-responsive"  />
                </a>
                <!-- END LOGO -->
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    <ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li>
                            ...
                            <?php //sidemenu($_REQUEST['nom'], $_REQUEST['bod']);          ?>
                            </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="portlet green box">
                                            <div class="portlet-title">
                                                <div class="caption"><i class="icon-cogs"></i>Member Information</div>
                                                <div class="tools">

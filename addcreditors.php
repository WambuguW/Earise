                        ...
                        <div class=" col-md-offset-1 col-md-11">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Add Creditors
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['create'])) {
                                                    ...
                                                    $newuser->addcreditors($_SESSION['users'], $_REQUEST['dname'], $_REQUEST['address'], $_REQUEST['dcont'], $_REQUEST['demail'], $_REQUEST['kra'], $_REQUEST['terms']);
                                                }

                                                if (isset($_REQUEST['gid']) || isset($_REQUEST['gedit']) || isset($_REQUEST['save']) || isset($_REQUEST['credel'])) {

                                                    if (isset($_REQUEST['gid'])) {

                                                        $id = $_REQUEST['gid'];

                                                        $sql = mysql_query('SELECT * FROM addcreditor WHERE id="' . $id . '"') or die(mysql_error());

                                                        $rows = mysql_fetch_array($sql);

                                                        creditorsedit($rows['id'], base64_decode($rows['dname']), base64_decode($rows['address']), base64_decode($rows['dcont']), base64_decode($rows['demail']), base64_decode($rows['kra']), base64_decode($rows['terms']), base64_decode($rows['status']));
                                                    }

                                                    if (isset($_REQUEST['save'])) {
                                                        creditorupdate($_SESSION['users'], $_REQUEST['id'], $_REQUEST['dname'], $_REQUEST['address'], $_REQUEST['dcont'], $_REQUEST['demail'], $_REQUEST['kra'], $_REQUEST['terms'], $_REQUEST['status']);
                                                    }

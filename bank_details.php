                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <ul id="countrytabs" class="nav nav-tabs ">
                                                <li class="active"><a href="tab"  data-toggle="tab" rel="country1" >Add bank</a></li>
                                                <li><a href="#" data-toggle="tab"  rel="country2">Banks Branches</a></li>
                                            ...
                                            <div class="col-md-12" style=" margin-bottom: 1em; padding: 10px">
                                                    ...
                                                    <div id="country1"  class="tabcontent active" style=" width:1200px;">
                                                        <?php
                                               
                                                if(isset($_REQUEST['btnaddbank'])){
                                                    $newuser->addMemberbank(base64_encode(strtoupper($_REQUEST['bank_name'])));
                                                }
                                               else if(isset($_POST[btneditbank])){
                                                          editMemberBanks($_POST['ID'],$_POST['bnkname']);  
                                                        }else if(isset($_POST['btnupdatebank'])){
                                                         $newuser->updateMemberbank($_POST['theid'],base64_encode(strtoupper($_REQUEST['bank_name'])));   
                                                        }else if(isset($_POST['btndeletebank'])){
                                                         $newuser->deleteMemberbank($_POST['theId']);   
                                                        }
                                                else{
                                                    bank_detail();
                                                }
                                                ?>
                                                    ...
                                                    <div id="country2" class="tabcontent" style=" width:1200px;">
                                                        ...
                                                        if(isset($_POST[btneditbranch])){
                                                          ...
                                                          editBankBranches($_POST['ID'],$_POST['bankid'],$_POST['brachname']);  
                                                        }else if(isset($_POST['btnaddbranch'])){
                                                         $newuser->addMemberbankBranch(base64_encode($_POST['bankID']),base64_encode(ucfirst($_REQUEST['branch'])));   
                                                        }else if(isset($_POST['btnupdatebranch'])){
                                                          $newuser->updatebankBranch($_POST['theid'],base64_encode($_POST['bankID']),base64_encode(ucfirst($_REQUEST['branch'])));   
                                                }else if(isset($_POST['btndeletebranch'])){
                                                    deletebankBranch($_POST['theId']);
                                                }

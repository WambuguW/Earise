                        ...
                        <div class="col-md-10 col-md-offset-1 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>Upload Loan Repayment 
                                                    ...
                                                    if (!in_array($file_extension, $file_format)) {
                                                        ...
                                                        do {
                                                            if ($data[0]) {
                                                                ...
                                                                $sth = mysql_query("INSERT INTO check_off (payee,payeeid,transid,mno,amount,session,date,bnkid) VALUES 
                ( 
                    '" . base64_encode($payee) . "', 
                    '" . base64_encode($payeeid) . "', 

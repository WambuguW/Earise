                    ...
                    <div class="col-md-offset-1 col-md-10 col-sm-10">
                        ...
                        <div class="portlet box green calendar">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-reorder"></i> Balance Brought Forward
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                            if (isset($_REQUEST['sharessub'])) {
                                                $newuser->balancebf($_SESSION['users'], $_REQUEST['mno'], $_REQUEST['sharesbf'], $_REQUEST['loan'], $_REQUEST['comments'], $_REQUEST['tid'],$_REQUEST['date']);
                                            }


                                            if (isset($_REQUEST['sharesedit']) || isset($_REQUEST['sid']) || isset($_REQUEST['sace']) || isset($_REQUEST['sdel'])) {

                                                if (isset($_REQUEST['sid'])) {

                                                    $id = $_REQUEST['sid'];

                                                    $sql = mysql_query('SELECT * FROM sharesbf WHERE id="' . $id . '"') or die(mysql_error());

                                                    $rows = mysql_fetch_array($sql);

                                                    editbalancebfform($_SESSION['users'], $rows['id'], base64_decode($rows['memberno']), base64_decode($rows['sharesbf']), base64_decode($rows['loanbf']), base64_decode($rows['comments']));
                                                }
                                                if (isset($_REQUEST['sace'])) {
                                                    sharesupdate($_SESSION['users'], $_REQUEST['id'], $_REQUEST['sharesbf'], $_REQUEST['loanbf'], $_REQUEST['comments'],$_REQUEST['date']);
                                                }

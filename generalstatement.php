                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> General Member Statements
                                        ...
                                        <div class="noprint">
                                            ...
                                            //if ($users->permissions($_SESSION['users'], $permission)) {
                                                ...
                                                <div class="simpleTabsContent">
                                                    <?php
                                                    generalstatemntreport($_SESSION['users'], $_REQUEST['mno'], $_REQUEST['datefrom'], $_REQUEST['dateto']);
                                                    ?>
                                                   
                                                        <div class="col-md-4"><input type="button" class="btn green" onclick="tableToExcel('my_table')" value="Export to Excel"></div>
                                                        <?php

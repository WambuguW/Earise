...
if (isset($_GET['id']) && isset($_GET['acname'])) {
    $id = $_GET['id'];
    $sqll = mysql_query("DELETE FROM fixedassets WHERE id='$id' ") or die(mysql_error());
...
if (isset($_REQUEST['acsubmit'])) {
    ...
    $newuser->addassets($_SESSION['user'], $_REQUEST['sasset'], $_REQUEST['lasset'], $_REQUEST['asvalue'], $_REQUEST['assetcat'], $_REQUEST['assetloc'], $_REQUEST['barcode'], $_REQUEST['serialno'], $_REQUEST['deptype'], $_REQUEST['deprate']);
}
                        ...
                        <div class=" col-md-offset-1 col-md-11">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Add Asset
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            if (isset($_REQUEST['acid']) || isset($_REQUEST['accedit']) || isset($_REQUEST['ace'])) {
                                                ...
                                                if (isset($_REQUEST['acid'])) {
                                                    ...
                                                    $sql = mysql_query('SELECT * FROM fixedassets WHERE id="' . $id . '"') or die(mysql_error());

                                                    $rows = mysql_fetch_array($sql);

                                                    assetnewedit($_SESSION['user'], $rows['id'], base64_decode($rows['sassets']), base64_decode($rows['lassets']), base64_decode($rows['asvalue']), base64_decode($rows['assetscat']), base64_decode($rows['assetsloc']), base64_decode($rows['barcode']), base64_decode($rows['serialno']), base64_decode($rows['deptype']), base64_decode($rows['deprate']));
                                                }
                                                if (isset($_REQUEST['ace'])) {
                                                    fixedassetupdate($_SESSION['user'], $_REQUEST['id'], $_REQUEST['sasset'], $_REQUEST['lasset'], $_REQUEST['asvalue'], $_REQUEST['assetcat'], $_REQUEST['assetloc'], $_REQUEST['barcode'], $_REQUEST['serialno'], $_REQUEST['deptype'], $_REQUEST['deprate']);
                                                }

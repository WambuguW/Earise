                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Dynamic Contribution Statements
                                                            ...
                                                            <div class="art-layout-cell" style="width: 100%" >
                                                                <div class="simpleTabs">
                                                                    ...
                                                                    <div class="simpleTabsContent">
                                                                        <?php
                                                                        accsdyna($_SESSION['users'], $_REQUEST['mno'], $_REQUEST['tname'], $_REQUEST['datefrom'], $_REQUEST['dateto']);
                                                                        ?>

                                                                        <div class="col-md-4"><input type="button" class="btn green" onclick="tableToExcel('samp')" value="Export to Excel"></div>

                ...
                <div class="col-md-offset-1 col-md-8 col-sm-8">
                    ...
                    <div class="portlet box green calendar">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-reorder"></i> Currency Settings
                            ...
                            <div class="well dark_green">
                                ...
                                <div class="art-layout-cell art-content clearfix">
                                   ...
                                   if(isset($_POST['addcurrency'])){
                                     $users-> addcurrencyset(base64_encode("superadmin"),  base64_encode($_POST['currencyname']),base64_encode($_POST['code']),base64_encode($_POST['symbol'])); 
                                   }
                                   currencysettings();

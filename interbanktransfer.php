                                        ...
                                        <div class=" col-md-offset-1 col-md-11">
                                            ...
                                            <div class="portlet box green calendar">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="icon-reorder"></i>Interbank Transfers
                                            ...
                                            ?>
                                                                      <?php
                                                                                       if(isset($_POST['submit56'])){
                                                                                         ...
                                                                                         $bank->interbank($_SESSION['user'],$_POST['accnofrom'],$_POST['accto'],  base64_encode($_POST['trasoff']),base64_encode($_POST['appauth']),base64_encode($_POST['purp']),base64_encode($_POST['dnt']),base64_encode($_POST['modep']),base64_encode($_POST['slipco']),base64_encode($_POST['amount']) );
                                                                                                }
                                                                                         interbank();
                                                        ?>
                                                            <?php

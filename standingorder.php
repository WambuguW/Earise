                            ...
                            <div class="art-layout-cell art-sidebar1 clearfix"><div class="art-vmenublock clearfix">
                                ...
                                <div class="simpleTabs">
                                    <ul class="simpleTabsNavigation">
                                        <li><a href="#">Standing Order - Loans</a></li>
                                    ...
                                    <div class="simpleTabsContent">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            <article class="art-post art-article">
                                                <h2 class="art-postheader"><span class="art-postheadericon">Standing Orders -(LOANS)</span></h2>

                                                <!------form start----->

                                                <?php
                                                //standingorders();
                                                if (isset($_REQUEST['finito'])) {
                                                    ...
                                                    for ($i = 0; $i < count($_REQUEST['check']); $i++) {
                                                        ...
                                                        $newuser->loanpay($_SESSION['users'], "member deposits", getloaname($_SESSION['loan']), $amount, $_REQUEST['tid'], $perm);
                                                    }
                                                }
                                                    ...
                                                    <form action="" method="get" autocomplete="off" id="frm1">
                                                        ...
                                                        <div class = "art-content-layout">
                                                            <div class = "art-content-layout-row">
                                                                <div class = "art-layout-cella" style = "width: 100%">
                                                                    ...
                                                                    <?php
                                                                    $qyy = mysql_query('select * from loanapplication where status="' . base64_encode("pending") . '" and loantype="' . base64_encode($lloan) . '"') or die(mysql_error());
                                                            ...
                                                            <div class="six"><label>Amount (Kshs.)</label><input type="number" name="amount[]" title="Select amount of choice"></div></ul>';
                                                                    }
                                                                    ?>
                                                        ...
                                                        <div class = "art-content-layout">
                                                            <div class = "art-content-layout-row">
                                                                <div class = "art-layout-cell" style = "width: 100%" >
                                                                    <div class = "four">
                                                                        <button name="finito">Finish</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

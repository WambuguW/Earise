    ...
    <head>
        ...
        <script>
            ...
            var content = document.getElementById('mt').innerHTML;
                    ...
                    pwin.document.open();
                    pwin.document.write('<html><link rel="stylesheet" href="assets/plugins/bootstrap/css/bootstrap.min.css"><body style="font-family:Arial, Helvetica, sans-serif; font-size:8px; text-align:center; width:90%;margin-left:5%; margin-right:5%; background-color:#FFF;" onload="window.print()">' + content + '</body></html>');
                    pwin.document.close();
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Income Reports
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                <div class="col-md-4">
                                                  ...
                                                  <input type="button" class="btn green" onclick="tableToExcel('sample_2')" name="income" value="Export to Excel">

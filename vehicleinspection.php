                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Vehicle Inspection
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['submit'])) {
                                                    $newv->vehicleinspectiondetails($_SESSION['users'], $_REQUEST['inspectee'], $_REQUEST['regno'], $_REQUEST['inspectiondate'], $_REQUEST['bodyworks'], $_REQUEST['tyres'], $_REQUEST['mechstatus'], $_REQUEST['findings'], $_REQUEST['recommendations'], $_REQUEST['comments'], $_REQUEST['insure'], $_REQUEST['expire'], $_REQUEST['cert'], $_REQUEST['tlb']);
                                                }
                                                vehicleinspection();

                        ...
                        <div class="col-md-13">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>Loan Write Off Module
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['wrid'])) {

                                                    $newuser->addloanwriteoff($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['mno']);
                                                }
                                                
                                                if (isset($_REQUEST['rwid'])) {

                                                    $newuser->removeloanwriteoff($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['mno']);
                                                }

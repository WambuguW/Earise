                        ...
                        <div class=" col-md-12 ">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Next of Kin Reports
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            ?>
                                            <label>Select Member Number</label>
                                                <select class="form-control input-medium select2me" name="kin" data-placeholder="Select Member Number" onchange="showKin(this.value)">
                                                    <?php
                                            echo '<option></option>';
...
function showKin(str)
            ...
            {
            document.getElementById("kin").innerHTML = xmlhttp.responseText;
            }
            }
            xmlhttp.open("GET", "get_kin.php?q=" + str, true);
                    xmlhttp.send();
            }
</script>

                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> General Ledger
                                                    ...
                                                    <div class="art-content-layout">
                                                        <div class="art-content-layout-row">
                                                            <div class="art-layout-cell" style="width: 100%" >
                                                                ...
                                                                ?>
                                                                <div class="col-md-6">
                                                                    <table aria-describedby="sample_2_info" class="table table-striped table-bordered table-hover table-full-width dataTable" id="sample_2">
                                                                        <tr><th>Account</th><th>Amount</th><th>Debit</th><th>Credit</th></tr>
                                                                        <?php
                                                                        acname("user", $_SESSION['datefrom'], $_SESSION['dateto']);
                                                                        liabilities();

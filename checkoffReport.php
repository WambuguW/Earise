                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Check Off Report
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            if (!isset($_POST['search'])) {
                                                ...
                                                memberCheckOffReport($_POST['mnth'], $_POST['org']);
                                                ?>
                                                <div class="col-md-8">
                                                    <input type="button" class="btn green" onclick="tableToExcel('tableToExcel')" value="Export to Excel">
                                                    <div class="col-md-4"><?php // vehicleexpor();  ?>  </div>

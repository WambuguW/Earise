                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Withdrawal Form
  ...
  $stmt = mysql_query("SELECT * FROM  newmember where status='" . base64_encode('active') . "' ");
    while ($row = mysql_fetch_array($stmt)) {
        echo '<option  value="' . base64_decode($row['membernumber']) . '">' . getMembername($row['membernumber']) . '-' . base64_decode($row['membernumber']) . ' </option>';
                                                       ...
                                                       <lable>Enter Member Number</lable>
                                                            <input type="text" name="mysearch" class="form-control input-medium"  required="required" title="Enter Member Number to search" placeholder="Enter Member Number to search" onkeyup="showUser(this.value)"/>
                                                        </div-->
                                                    </form>
                                                ...
                                                if (isset($_REQUEST['submit'])) {
                                                    $with->withdrawal("user", $_REQUEST['mno'], $_REQUEST['amount'], $_REQUEST['cheque'], $_REQUEST['fees'], $_REQUEST['approvedby'], $_REQUEST['comments']);
                                                }

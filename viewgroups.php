                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>Contribution Groups Reports
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['gsubmit'])) {
                                                    viewgroups($_REQUEST['gname']);
                                                    //meexport($_REQUEST['gname']);
                                                }
...
<SCRIPT LANGUAGE="javascript">
                                                function Del()
                                                        {
                                                        var r = confirm("Are you sure you want to unsubscribe the member?")

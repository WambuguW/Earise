                ...
                <div class="col-md-offset-1 col-md-10 col-sm-10">
                    ...
                    <div class="portlet box green calendar">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-reorder"></i> Interest On Savings Settings
                        ...
                        <div class="portlet-body dark_green" style="color:#000000">
                            <div class="well dark_green">
                             ...
                             if(isset($_POST['btnsubmit'])){
                                 ...
                                 $users -> interest_saving_setting($_POST['saving_acc'],$_POST['accrue_period'],$_POST['post_period'],$_POST['interest_rate'],$_POST['interestGl'], $_POST['interestmember']);
                                 
                             }else if(isset($_POST['btnview'])){
                                 viewInterest_setting();
                                 
                             }else if(isset($_POST['btneidt'])){
                                 editInterest_setting($_POST['IDs']);
                                 
                             }else if(isset($_POST['btnUpdate'])){
                                 $users -> update_saving_setting($_POST['IDS'],$_POST['gLID'],$_POST['saving_acc'],$_POST['accrue_period'],$_POST['post_period'],$_POST['interest_rate'],$_POST['interestGl'], $_POST['interestmember']);
                             }
                             else{
                               interst_save();   

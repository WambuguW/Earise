...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.0.0.58475 -->
                ...
                <div class="col-md-offset-1 col-md-10 col-sm-10">
                    ...
                    <div class="portlet box green calendar">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-reorder"></i> Permissions Edit
                        ...
                        <div class="portlet-body dark_green" style="color:#000000">
                            <div class="well dark_green">
                                ...
                                <div class="art-layout-cell art-content clearfix">
                                    <!------form start----->
                            <?php
                            if(isset($_REQUEST['adppe'])){
                                edditedPemissionEdit($_REQUEST['adppe']);
                                $id= ($_REQUEST['adppe']);
    ...
    while ($row = mysql_fetch_array($stmt)) {
                            ...
                            if(isset($_REQUEST['perumpdate'])){
                                updatePermission($_REQUEST['adppe'],$_REQUEST['grp'],$_REQUEST['perm'],$_REQUEST['status'], $oldstatus);
                            }
                            if(isset($_REQUEST['adppd'])){
                                      include ('del.php');   
                                    }
                           if (!isset($_REQUEST['adppe']) && !isset($_REQUEST['perumpdate']) && !isset($_REQUEST['adppd'])) {

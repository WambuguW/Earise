    ...
    <head>
        ...
        <script type="text/javascript">
            function showUser(str)
            {
                ...
                xmlhttp.open("GET", "./search/vehreg.php?q=" + str, true);
                xmlhttp.send();
            }
        </script>
        <script type="text/javascript">
                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Search Vehicles by Nickname or Number Plate
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <form action="" method="post">
                                                <div class="searcher">
                                                    <input class="form-control input-large" type="text" name="mysearch" autofocus required="required" title="Enter Member Number to search" placeholder="Enter Member Number to search" onkeyup="showUser(this.value)"/>
                                                </div>
                                            </form> 
                                            ...
                                            if (isset($_REQUEST['vid']) || isset($_REQUEST['update']) || isset($_REQUEST['vdel'])) {

                                                if (isset($_REQUEST['vid'])) {
                                                    vehicleregedit($_REQUEST['vid']);
                                                }

                                                if (isset($_REQUEST['update'])) {

                                                    $reg->regeditvehicle($_SESSION['users'], $_REQUEST['id'], $_REQUEST['mno'], $_REQUEST['regno'], $_REQUEST['logbookno'], $_REQUEST['vvalue'], $_REQUEST['purchasedate'], $_REQUEST['vehicletype'], $_REQUEST['routes'], $_REQUEST['capacity'], $_REQUEST['comments'], $_REQUEST['fleet'], $_REQUEST['status'], $_REQUEST['nickname'], $_REQUEST['dri'], $_REQUEST['cond'], $_REQUEST['comments']);
                                                }

                            ...
                            <div class="well dark_green">
                                ...
                                <div class="art-layout-cell art-content clearfix">
                                    ...
                                    <div class="art-layout-cell art-content clearfix">
                                        ...
                                        if (isset($_REQUEST['submit'])) {
                                            ...
                                            if ($image) {
                                                ...
                                                if (!$copied) {
                                                    ...
                                                    //$ok = 0;
                                                    $users->adduser($_SESSION['users'], $_REQUEST['fname'], $_REQUEST['mname'], $_REQUEST['lname'], $_REQUEST['idno'], $_REQUEST['mobile'], $_REQUEST['email'], $_REQUEST['uname'], $_REQUEST['password'], $_REQUEST['ulevel'], $_REQUEST['status'], $image, $_REQUEST['comments']);
                                                } else {
                                                    $users->adduser($_SESSION['users'], $_REQUEST['fname'], $_REQUEST['mname'], $_REQUEST['lname'], $_REQUEST['idno'], $_REQUEST['mobile'], $_REQUEST['email'], $_REQUEST['uname'], $_REQUEST['password'], $_REQUEST['ulevel'], $_REQUEST['status'], $image, $_REQUEST['comments']);
                                                }
                                            }
                                        ...
                                        if (!isset($_REQUEST['edit']) && !isset($_REQUEST['aid']) && !isset($_REQUEST['use'])) {
                                        ...
                                        if (isset($_REQUEST['use'])) {
                                            ...
                                            if ($image) {
                                                ...
                                                if (!$copied) {
                                                    ...
                                                    // 0-unsuccessfull, 1-successfull
                                                    //$ok = 0;
                                                    $admin->updateuser("superadmin", $_REQUEST['id'], $_REQUEST['fname'], $_REQUEST['mname'], $_REQUEST['lname'], $_REQUEST['idno'], $_REQUEST['username'], $_REQUEST['password'], $_REQUEST['email'], $_REQUEST['mobile'], $_REQUEST['ulevel'], $_REQUEST['status'], $image, $_REQUEST['comments']);
                                                } else {
                                                    $admin->updateuser("superadmin", $_REQUEST['id'], $_REQUEST['fname'], $_REQUEST['mname'], $_REQUEST['lname'], $_REQUEST['idno'], $_REQUEST['username'], $_REQUEST['password'], $_REQUEST['email'], $_REQUEST['mobile'], $_REQUEST['ulevel'], $_REQUEST['status'], $image, $_REQUEST['comments']);
                                                }
                                            }
                                        ...
                                        if (isset($_REQUEST['aid'])) {
                                            ...
                                            useredit("superadmin", $rows['id'], base64_decode($rows['fname']), base64_decode($rows['mname']), base64_decode($rows['lname']), base64_decode($rows['idno']), base64_decode($rows['username']), base64_decode($rows['password']), base64_decode($rows['email']), base64_decode($rows['phone']), base64_decode($rows['picture']), base64_decode($rows['userlevel']), base64_decode($rows['status']), base64_decode($rows['comments']));
                                        }
                                        ?>
                                        </table>
                                    </div>

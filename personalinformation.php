                                               ...
                                               <div class="portlet-body form">
                                                    <form action="" class="form-horizontal" method="post">
                                                        <div class="col-md-4 col-md-offset-1">
                                                            <label>Select Member Number </label> <select name = "mno" id="select2_sample4" onchange = "showUser(this.value)" data-placeholder="Select Member Number" value = "' . $_REQUEST['mno'] . '" class="input-medium form-control  select2me">
                                                                <option></option>
                                                                <?php
                                                ...
                                                if (isset($_POST['edit'])) {
                                                    ...
                                                    $dob = $_POST['dob'];
                                                    if (strtotime($dob) > strtotime($newtime)) {
                                                        echo '<div style="color: red">Member must be 18 years and above!</div>';
                                                    } else {
...
copy($_FILES['image']['tmp_name'],"$folder/$image");
}}else{
	$image=$_POST['pro_pic'];
}
                                                                ...
                                                                //$ok = 0;
                                                                $d = new DateTime($_POST['dob']);
                                                                $dob = $d->format('d-M-Y');
                                                                $newuser->editmember($_SESSION['users'],$_POST['theid'],$_POST['title'],$_POST['mno'],$_POST['fname'],$_POST['mname'],$_POST['lname'],$_POST['regdate'],$_POST['dob'],$_POST['gender'],$_POST['idno'],$_POST['mobile'],$_POST['krapin'],$_POST['email'],$_POST['postaldress'],$_POST['country'],$_POST['county'],$_POST['residence'],$_POST['buildingname'],$_POST['occupation'],$_POST['org'],$_POST['bus_location'],$_POST['period_save'],$_POST['freq_payment'],$_POST['introduced_by'],$_POST['comment'],$_POST['status'],$_POST['member_cate'],$_POST['cro'],$image);
                                                ...
                                                if (isset($_REQUEST['btnmembercat'])) {
                                                    $newuser->AddMemberCategory($_REQUEST['prefix'], $_REQUEST['cat_name']);
                                                }
                                                //add member titles
                                                if (isset($_REQUEST['btnaddtitles'])) {
                                                    $newuser->AddMemberTitles($_REQUEST['title_name']);
                                                }
                                                ?>
...
<script type="text/javascript">
    function showUser(str)
    {
        ...
        xmlhttp.open("GET", "./search/infosearch.php?q=" + str, true);
        xmlhttp.send();
    }
</script>
</body>

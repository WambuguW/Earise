                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>Clear Loan Repossessions
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['submit'])) {
                                                    ...
                                                    clearepoloan($_SESSION['users'], $_REQUEST['id'], $_REQUEST['mno'], $_REQUEST['tid'], $_REQUEST['loant'], $_REQUEST['fee'], $_REQUEST['amount']);
                                                }

                                                if (isset($_REQUEST['lid'])) {

                                                    clearloanrepoform($_SESSION['users'], $_REQUEST['lid'], $_REQUEST['tid']);
                                                } else {

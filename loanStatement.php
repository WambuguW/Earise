...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            xmlhttp.open("GET", "./search/loanStatement.php?q=" + str, true);
                    xmlhttp.send();
            }
        </script>
        <script type="text/javascript">
                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>  Loan   Statements
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix" id="mtn">
                                            <?php
                                            ...
                                            if (isset($_REQUEST['btntid'])) {
                                                ?>  <div id="mt">
                                                <?php
                                                loanStatement(($_REQUEST['tid']));
                                                ?>
                                                </div>
                                                <input type="button" class="btn green" onClick="return printResults()" value="print">
                                                <input type="button" class="btn green" onclick="tableToExcel('mtn')" value="Export to Excel">
    <?php
}
?>
                                        </div>

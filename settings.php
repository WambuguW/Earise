                        ...
                        <div class="portlet-body dark_green" style="color:#000000">
                            <div class="well dark_green">
                              ...
                              <?php
                                                                ...
                                                                if (isset($_REQUEST['ref1'])) {
                                                                    
                                                                    $sacco->settingsupdate($_SESSION['users'], $_REQUEST['days'],  $_REQUEST['aed'], $_REQUEST['usd'], $_REQUEST['bank'],$_REQUEST['date'], $_REQUEST['definsurance'] , $_REQUEST['deflegal'], $_REQUEST['accruedAcc'], $_REQUEST['currency'],$_REQUEST['defsaacc'],$_REQUEST['mindsacc'], $_REQUEST['defscacc'], $_REQUEST['minscacc'], $_REQUEST['defprocess'], $_REQUEST['maxloan'],$_REQUEST['system_url'],$_REQUEST['dashboard_url']); 
                                                                }

                ...
                <div class=" col-md-10 col-sm-10 col-md-offset-1">
                    ...
                    <div class="portlet box green calendar">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-reorder"></i> Withdraw Fees Settings
                            ...
                            <div class="well dark_green">
                                ...
                                <div class="art-layout-cell art-content clearfix">
                                    ...
                                    if(isset($_REQUEST['btnreg'])){
                                      ...
                                      $users -> insert_withdrawfee($amtfrom,$amtto,$amount,$_POST['lname'],$_POST['glaccount']);
                                        }
                                    }
                                    withdrawFeeSetting();

                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>Invoice Vehicle Payment
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            if (isset($_POST['payinvoice'])) {
                                                ...
                                                $lect->insertInvoicePayment(base64_encode($_POST['acc']), base64_encode($_POST['vid']),  vehicleOwner($_POST['vid']), base64_encode($_POST['payee']), base64_encode($_POST['amount']), base64_encode($_POST['date']));
                                            }
                                            vehiclePaymentInvoice();
                                            ?>
                                            <?php
                                            }else{

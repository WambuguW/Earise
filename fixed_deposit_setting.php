                ...
                <div class="col-md-offset-1 col-md-10 col-sm-10">
                    ...
                    <div class="portlet box green calendar">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-reorder"></i>Fixed deposit Settings
                            ...
                            <div class="well dark_green">
                              ...
                              <?php
                                                               ...
                                                               if (isset($_REQUEST['btnadd'])) {
                                                                    $sacco->fixedDepositCreate($_SESSION['users'], $_REQUEST['actname'],  $_REQUEST['regfee'], $_REQUEST['closefee'], $_REQUEST['managefee'],$_REQUEST['freq_manage'],$_REQUEST['interestRate'],$_REQUEST['minbalance'],$_REQUEST['maxbalance'],$_REQUEST['penalty'],$_REQUEST['fre_accrual'],$_REQUEST['fre_posting'],$_REQUEST['accountfeeGl'],$_REQUEST['interestGl'],$_REQUEST['manageGl'],$_REQUEST['postglaccount']);
                                                                }else if(isset($_POST['btnview'])){
                                                                    ViewFixed_setting();
                                                                }
                                                                else if(isset($_POST['btneidt'])){
                                                                    editFixedSettings($_POST['ID']);
                                                                    
                                                                } else if(isset($_POST['btnUpdate'])){
                                                                   $sacco->fixedDepositUpdate($_POST['IDS'],$_POST['GL_ID'], $_REQUEST['actname'],  $_REQUEST['regfee'], $_REQUEST['closefee'], $_REQUEST['managefee'],$_REQUEST['freq_manage'],$_REQUEST['interestRate'],$_REQUEST['minbalance'],$_REQUEST['maxbalance'],$_REQUEST['penalty'],$_REQUEST['fre_accrual'],$_REQUEST['fre_posting'],$_REQUEST['accountfeeGl'],$_REQUEST['interestGl'],$_REQUEST['manageGl'],$_REQUEST['postglaccount']);

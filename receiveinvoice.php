                        ...
                        <div class=" col-md-offset-1 col-md-11">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Receive Invoice
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['create'])) {
                                                    ...
                                                    $newuser->addreceivedinvoice($_SESSION['users'], $_REQUEST['creditor'], $_REQUEST['dateinvoice'], $_REQUEST['glacc'], $_REQUEST['amount'], $_REQUEST['invono'], $_REQUEST['duedate'], $_REQUEST['description'], $_REQUEST['status']);
                                                }

                                                if (isset($_REQUEST['gid']) || isset($_REQUEST['gedit']) || isset($_REQUEST['save']) || isset($_REQUEST['recel'])) {

                                                    if (isset($_REQUEST['gid'])) {

                                                        $id = $_REQUEST['gid'];

                                                        $sql = mysql_query('SELECT * FROM receiveinvoice WHERE id="' . $id . '"') or die(mysql_error());

                                                        $rows = mysql_fetch_array($sql);

                                                        rinvoicedit($rows['id'], base64_decode($rows['creditorid']), base64_decode($rows['invdate']), base64_decode($rows['glacc']), base64_decode($rows['amount']), base64_decode($rows['invno']), base64_decode($rows['duedate']), base64_decode($rows['status']), base64_decode($rows['description']));
                                                    }

                                                    if (isset($_REQUEST['save'])) {
                                                        recinvoiceupdate($_SESSION['users'], $_REQUEST['id'], $_REQUEST['creditor'], $_REQUEST['invdate'], $_REQUEST['glacc'], $_REQUEST['amount'], $_REQUEST['invno'], $_REQUEST['duedate'], $_REQUEST['status'], $_REQUEST['description']);
                                                    }

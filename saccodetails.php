                ...
                <div class="col-md-offset-1 col-md-10 col-sm-10">
                    ...
                    <div class="portlet box green calendar">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-reorder"></i> Sacco details
                                    ...
                                    if (isset($_REQUEST['submit'])) {
                                        ...
                                        if ($image) {
                                            ...
                                            if (!$copied) {
                                                ...
                                                //$ok = 0;
                                                $sacco->details($_SESSION['users'], $_REQUEST['name'], $_REQUEST['phaddress'], $_REQUEST['poaddress'], $_REQUEST['branchno'], $_REQUEST['telno'], $_REQUEST['email'], $_REQUEST['mobile'], $_REQUEST['website'], $_REQUEST['slogan'], $image);
                                            } else {
                                                $sacco->details($_SESSION['users'], $_REQUEST['name'], $_REQUEST['phaddress'], $_REQUEST['poaddress'], $_REQUEST['branchno'], $_REQUEST['telno'], $_REQUEST['email'], $_REQUEST['mobile'], $_REQUEST['website'], $_REQUEST['slogan'], $image);
                                            }
                                        }

                        ...
                        <div class=" col-md-offset-1 col-md-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Accrue interest on savings
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            ?>
<?php 
//when run, this function accrues interest on savings
  $newuser-> accruedInterest();

  //when run it posts the accrued interest to given members
  $newuser-> postAccruedInterest();

                        ...
                        <div class="col-md-13">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>Interest Waiver/Freeze Module
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['fid'])) {
                                                    ...
                                                    $newuser->addinterestfreeze($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['mno']);
                                                }

                                                if (isset($_REQUEST['wid'])) {

                                                    interestwaive($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['mno']);
                                                } 
                                                
                                                
                                                if (isset($_REQUEST['ufid'])) {

                                                    $newuser->removeinterestfreeze($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['mno']);
                                                }

                                                if (isset($_REQUEST['uwid'])) {

                                                    removeinterestwaive($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['mno']);
                                                } 

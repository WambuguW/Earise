                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i>Register Agents
                                ...
                                <div class="portlet-body dark_green" style="color:#000000">
                                    <div class="well dark_green">
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            $addAgents->agentsRegistration($_SESSION['users'], base64_encode($_POST['fname']), base64_encode($_POST['mname']) , base64_encode($_POST['lname']), base64_encode($_POST['idno'],base64_encode($_POST['email']),base64_encode($_POST['contact'])));
                                                }
                                            
                                            if(isset($_POST['update']) ||  isset($_REQUEST['edit']) || isset($_REQUEST['edi']) ){
                                               ...
                                               if(isset($_REQUEST['edi'])){
                                                 editAgentsForm($_REQUEST['edi']);  
                                               } 
                                               
                                               if(isset($_REQUEST['Update'])){
                                                 updateAgents($_SESSION['users'], $_POST['id'],base64_encode($_POST['fname']), base64_encode($_POST['mname']) , base64_encode($_POST['lname']), base64_encode($_POST['idno']),base64_encode($_POST['email']),base64_encode($_POST['contact']));  
                                               } 

...
, format = function(s, c) {
    ...
    <!-- END HEAD -->
    <!-- BEGIN BODY -->
    <body class="page-header-fixed page-full-width" style="color:#272822; font-family:verdana; font-size:13px; background-image: url('../photos/10163510ENEZA 2015.jpg'); ">
        <!-- BEGIN HEADER -->
                        ...
                        <div class="col-md-12 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Finish Check Off 
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                           ...
                                           if(isset($_REQUEST['transfer'])){
                                               ...
                                               $amount=$_REQUEST['amount'][$i];
                                                       $mno=$_REQUEST['mno'][$i];
                                                       $tname=$_REQUEST['tname'][$i];
                                                       $date=$_REQUEST['date'][$i];
                                                       $tid=$_REQUEST['tid'][$i];
                                                       
                                              $lect->membercontribution($_SESSION['users'], $mno, 'NULL', $mno, getMembername(base64_encode($mno)), $tname, "Check Off", $amount, $date, $date, $date, $_SESSION['session'], $tid, $_REQUEST['transfer'], $_REQUEST['bankname']);

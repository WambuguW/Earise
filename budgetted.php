                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Complete Budget 
...
//standingorders();
                                            if (isset($_POST['finito'])) {
                                                ...
                                                for ($i = 0; $i < count($_POST['account']); $i++) {
                                                    ...
                                                    $newuser->addedbudget($_SESSION['users'], $account, $datefrom, $dateto, $amount, $no);
                                                }
                                            }
                                            ?>
                                            <form action="" method="POST" autocomplete="off" id="frm1">
                                                ...
                                                <table class="table table-striped table-bordered table-hover table-full-width">
                                                    <thead><th>Account</th><th>Date From</th><th>Date To</th><th>Amount</th></thead><tbody>
                                                        <?php
                                                        $idd = $_REQUEST['id'];
                                                        $no = 1 + $_REQUEST['no'];
                                                        $stmt = mysql_query("SELECT *  FROM budget    ORDER BY id DESC  LIMIT $no ");

                                                        while ($roiw = mysql_fetch_array($stmt)) {
                                                            echo '<tr><td><input type="hidden" name="account[]"  value="'.($roiw['account']).'"  class="input-medium  form-control" >
                                                            <div class="two"><label><center>' . getGlname(base64_decode($roiw['account'])) . '</center></label></div></td>
                                                           <td><div class="ouma"><input type="text" name="datefrom[]" data-date-format="dd-M-yyyy" class="input-medium  form-control date-picker " placeholder="Select Date From" title="Select Date From"></div></td>
                                                            <td><div class="ouma"><input type="text" name="dateto[]" data-date-format="dd-M-yyyy" class="input-medium  form-control date-picker" placeholder="Select Date To" title="Select Date To"></div></td>
                                                            <td><div class="ouma"><input type="number" class="input-medium  form-control" name="amount[]" placeholder="Enter Amount " title="Select amount of choice"></div></td></tr>';
                                                        }
                                                        ?>
                                                    </tbody></table>     
                                                <?php

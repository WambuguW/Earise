                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            if (isset($_REQUEST['importcsv'])) {
                                                    ...
                                                    if (!in_array($file_extension, $file_format)) {
                                                        ...
                                                        do {
                                                            if ($data[0]) {
                                                                ...
                                                                $newuser->saccoexpense($_SESSION['users'], $nextId, addslashes($data[5]), addslashes($data[9]), addslashes($data[6]), addslashes($data[8]), addslashes($data[2]), addslashes($data[3]), addslashes($data[4]), addslashes($data[4]),addslashes($data[0]), addslashes($data[1]), addslashes($data[10]), $_SESSION['sess'], '1', addslashes($data[7]));
                                                            }
                                                ...
                                                if (isset($_REQUEST['submit'])) {
                                                    $newuser->saccoexpense($_SESSION['users'], $_REQUEST['tid'], $_REQUEST['tname'], $_REQUEST['res'], $_REQUEST['ptype'], $_REQUEST['cheque'], $_REQUEST['apby'], $_REQUEST['date'], $_REQUEST['reason'], $_REQUEST['reason'], $_REQUEST['recvr'], $_REQUEST['rcvid'], $_REQUEST['comments'], $_SESSION['sess'], $_REQUEST['submit'], $_REQUEST['bankname']);
                                                }
                                                if (!isset($_REQUEST['submit']) && (!isset($_REQUEST['importcsv']))) {
                                                    //tabbed panel to allow manual data entry or file import.
                                                    expensesform(); //calls the functions below

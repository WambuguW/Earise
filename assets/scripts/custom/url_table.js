var TableEditable = function () {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[2].innerHTML = '<input id="menus" type="text" class="form-control" value="' + aData[2] + '">';
                 jqTds[3].innerHTML = '<input id="submenus" type="text" class="form-control" value="' + aData[3] + '">';
                    ...
                    $(document).ready(function ()
    {
            ...
            var name = $("#names").val();
            var menu = $("#menus").val();
             var Submenu = $("#submenus").val();

            var dataStr = 'url=' + url + '&name=' + name+ '&menu=' + menu + '&submenu=' + Submenu;

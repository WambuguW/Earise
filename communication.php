                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-10">
                            ...
                            <div class="portlet box green calendar">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> Communications
                                        ...
                                        <div class="art-layout-cell art-content clearfix">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['submit'])) {
                                                    echo'<div class="col-md-7" style="margin-left:200px;">';
                                                    $comm->communication($_SESSION['users'], $_REQUEST['number'], $_REQUEST['subject'], $_REQUEST['body']);
                                                    echo'</div>';
                                                }
